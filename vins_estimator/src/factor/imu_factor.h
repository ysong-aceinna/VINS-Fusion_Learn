...
//delta_q = Qi.inverse() * Qj;
        ...
        if (jacobians)
        {
            ...
            if (jacobians[3])
            {
                ...
                // LOG_IF(ERROR, !(fabs(jacobian_speedbias_j.maxCoeff()) < 1e8)) << "fabs(jacobian_speedbias_j.maxCoeff()) < 1e8";
                // LOG_IF(ERROR, !(fabs(jacobian_speedbias_j.minCoeff()) < 1e8)) << "fabs(jacobian_speedbias_j.minCoeff()) < 1e8";
            }
        }
